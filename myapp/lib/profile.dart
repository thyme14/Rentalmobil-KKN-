                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            RaisedButton.icon(
                              onPressed: () {
                                customLaunch(
                                    'mailto:<miftahgokil33@gmail.com>?subject=RENTAL MOBIL');
                              },
                              icon: Icon(Icons.email, color: Colors.red),
                              label: Text('Email:miftahgokil33@gmail.com'),
                      ...
                      Card(
                        child: Column(
                          ...
                          children: <Widget>[
                            RaisedButton.icon(
                              onPressed: () {
                                customLaunch('tel:<081297973316>');
                              },
                              icon: Icon(Icons.call, color: Colors.brown),
                              label: Text('Telepon:081297973316'),
                              color: Colors.lightBlue[50],
                            ),
                          ],
                        ),
